...
一个基于 C++17 与 [raylib](https://www.raylib.com/) 开发的 2D 迷宫解谜游戏，包含推箱子、机关、水流/岩浆扩散、敌人追踪等要素，仅支持 Windows 平台。

## 特性概览

- 栅格化迷宫地图，支持多关卡（`LEVEL1 -- LEVEL10` ）。
- 推箱子机关：分木箱，石箱，均可被玩家推动，用于挡路与解谜。
- 活塞与按钮系统：
...
- 在每一关中，从玩家起点出发，躲避岩浆和敌人，推动箱子、触发机关，最终抵达终点宝箱即可过关。
